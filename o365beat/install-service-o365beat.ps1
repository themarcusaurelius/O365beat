...
New-Service -name o365beat `
  ...
  -binaryPathName "`"$workdir\o365beat.exe`" -c `"$workdir\o365beat.yml`" -path.home `"$workdir`" -path.data `"C:\ProgramData\o365beat`" -path.logs `"C:\ProgramData\o365beat\logs`" -E logging.files.redirect_stderr=true"
